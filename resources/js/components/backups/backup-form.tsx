import { BackupFormData, SourceTree, SourceTreeItem } from '@/types/backups';
...
interface BackupFormProps {
    form: InertiaFormProps<BackupFormData>;
    sourceTree: SourceTree;
    destinations: Destination[];
    handleSubmit: (e: FormEvent<HTMLFormElement>) => void;
}

export default function BackupForm({ form, sourceTree, destinations, handleSubmit }: BackupFormProps) {
    return (
            ...
            <CardContent>
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="col-span-2 max-h-[70vh] min-h-72 overflow-y-auto rounded-md border bg-muted p-4">
                            <Label>Source</Label>
                        ...
                        <div className="col-span-2 flex justify-end">
                            <Button type="submit" disabled={form.processing}>
                                {Object.keys(form.data).includes('id')
                                    ? form.processing
                                        ? 'Updating...'
                                        : 'Update'
                                    : form.processing
